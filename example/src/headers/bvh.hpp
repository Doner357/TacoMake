...
class bvh_node : public hittable {
    public:
        ...
        bvh_node(std::vector<std::shared_ptr<hittable>>& objects, size_t start, size_t end) {
            ...
            int axis = bbox.longest_axis(); // Optimize space division by chosing longes axis
        ...
        bool hit(const ray& r, interval ray_t, hit_record& rec) const override {
            ...
            // Note that if you hit an object, you just need to check again to see
            // if there is an object that was hit closer than before
